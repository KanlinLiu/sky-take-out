...
public class ReportServiceImpl implements ReportService {
    ...
    public UserReportVO getUserStatistics(LocalDate begin, LocalDate end) {
        ...
        //存放每天的新增用户数量 select count(id) from user where create_time between < ? and create_time > ?
    ...
    public SalesTop10ReportVO getSalesTop10(LocalDate begin, LocalDate end) {
        //select name, sum(od.number) from order_detail od, orders o where od.order_id = o.id and o.status =5 and o.order_time > begin and o.order_time < end
        // group by od.name
